...
--
-- Host: 127.0.0.1    Database: p2p_lendingv2
-- ------------------------------------------------------
...
CREATE TABLE `transactions` (
  ...
  CONSTRAINT `transactions_ibfk_2` FOREIGN KEY (`block_id`) REFERENCES `blocks` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `mining_attempts_today` int DEFAULT '0',
...
-- Dump completed on 2025-04-10  7:53:05
